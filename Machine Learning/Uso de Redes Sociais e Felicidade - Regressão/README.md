...
- **Age** (Idade) (Média: 32.98, Mediana: 34, Desvio Padrão: 9.96, Assimetria: -0.12) segue uma distribuição quase uniforme, sem casos extremos (outliers). Usuários mais novos podem utilizar redes sociais com frequência maior, o que pode levar a níveis de felicidade mais baixos. Esta pode ser uma informação importante para o poder preditivo de nossos modelos. A única transformação necessária para esta coluna é a padronização (standardization).
- **Daily Screen Time** (Tempo diário de tela) (Média: 5.53, Mediana: 5.6, Desvio Padrão: 1.73, Assimetria: 0.03) possui uma distribuição quase normal, o que é confirmado pelo histograma e pelo valor baixo da assimetria. Observamos um caso extremo com tempo médio de tela de 10 horas por dia. Manteremos este ponto no dataset, para que nosso modelo tenha informações de usuários que utilizam redes sociais acima da média. Em uma análise real, seria interessante separar tempo de tela no trabalho (executando tarefas no computador para trabalho) e tempo de tela para lazer. Participantes que trabalham muitas horas no computador tem valores altos de tempo de tela diário, mas não necessariamente alto uso de redes sociais. Seria interessante ver se somente o uso de redes sociais impacta no nível de felicidade do participante, ou se o tempo de tela como um todo já afeta estes níveis. Não será necessário realizar nenhuma transformação nesta variável.
- **Sleep Quality** (Qualidade de sono) (Média: 6.3, Mediana: 6, Desvio Padrão: 1.52, Assimetria: 0.03) segue uma distribuição normal, sem casos extremos. Não é necessário realizar nenhuma transformação nesta coluna.
- **Stress Levels** (Nível de stress) (Média: 6.61, Mediana: 7, Desvio Padrão: 1.54, Assimetria: -0.09) também segue uma distribuição quase normal, mas com uma cauda esquerda levemente mais comprida, causada por um caso extremo com nível de stress igual a 2. Não há necessidade de realizar nenhuma transformação nesta variável.
- **Days without Social Media** (Dias sem redes sociais) (Média: 3.13, Mediana: 3, Desvio Padrão: 1.85, Assimetria: 0.079) tem uma distribuição normal com assimetria para a direita (a cauda esquerda é mais longa do que a cauda direita). Enquanto esta não é a distribuição ideal, não há necessidade de aplicar nenhuma transformação nesta coluna.
- **Exercise Frequency** (Frequência de exercício) (Média: 2.45, Mediana: 2, Desvio Padrão: 1.42, Assimetria: 0.23) também possui uma distribuição normal com assimetria para a direita. No entanto, tentativas de aplicar uma transformação de raíz quadrada ou uma transformação log1p aumenta a assimetria desta variável, então escolhemos não realizar nenhuma transformação.
- **Happiness Index** (Nível de felicidade) (Média: 8.37, Mediana: 9, Desvio Padrão: 1.52, Assimetria: -0.68) possui uma distribuição altamente assimétrica para a esquerda, de forma que temos mais participantes com níveis altos de felicidade do que com níveis baixos. A diferença na representação dos diferentes níveis de felicidade pode causar problemas em nossos modelos, criando um viés que favorece previsões de níveis de felicidade altos (overrepresentation bias). Para evitar isso, usaremos a técnica SMOTE de oversampling, que irá replicar dados aleatórios para os níveis de felicidade com menor representação e baleancear nosso dataset.
- **Gender** (Gênero) tem uma distribuição uniforme entre participantes dos gêneros masculino e feminino, com uma pequena porcentagem de participantes que se identificaram como Outro.
- **Social Media Platform** (Rede social preferida) segue uma distribuição uniforme entre todas as plataformas consideradas.

Seguimos com uma análise bivariacional, para entender como cada coluna impacta o nível de felicidade de um participante. Encontramos que:

- **Age** (Idade) não aparenta apresentar uma correlação significativa com o nível de felicidade does not seem to show any correlation with the Happiness Index. Therefore, this variable will not be a good predictor for our target feature.
